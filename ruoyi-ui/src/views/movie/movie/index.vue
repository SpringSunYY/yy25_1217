  ...
  <div class="app-container">
    ...
    <el-table :loading="loading" :data="movieList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="评分" align="center" :show-overflow-tooltip="true" v-if="columns[3].visible"
                       prop="rating"/>
      <el-table-column label="看过人数" align="center" :show-overflow-tooltip="true" v-if="columns[4].visible"
                       prop="viewCount"/>
      <el-table-column label="想看人数" align="center" :show-overflow-tooltip="true" v-if="columns[5].visible"
                       prop="wishCount"/>
      <el-table-column label="总影评数" align="center" :show-overflow-tooltip="true" v-if="columns[6].visible"
                       prop="reviewsCount"/>
      <el-table-column label="语言" align="center" :show-overflow-tooltip="true" v-if="columns[7].visible"
                       prop="language"/>
      <el-table-column label="国家地区" align="center" :show-overflow-tooltip="true" v-if="columns[8].visible"
                       prop="country"/>
      <el-table-column label="导演" align="center" :show-overflow-tooltip="true" v-if="columns[9].visible"
                       prop="directors"/>
      <el-table-column label="编剧" align="center" :show-overflow-tooltip="true" v-if="columns[10].visible"
                       prop="writers"/>
      <el-table-column label="主演" align="center" :show-overflow-tooltip="true" v-if="columns[11].visible"
                       prop="actors"/>
      <el-table-column label="片长" align="center" :show-overflow-tooltip="true" v-if="columns[12].visible"
                       prop="duration"/>
      <el-table-column label="片长" align="center" :show-overflow-tooltip="true" v-if="columns[13].visible"
                       prop="durationMinute"/>
