<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['movie:recommend:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['movie:recommend:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['movie:recommend:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['movie:recommend:export']"
        >导出</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleImport"
          v-hasPermi="['movie:recommend:import']"
        >导入</el-button>
      </el-col>
    ...
    <el-table :loading="loading" :data="recommendList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="推荐内容" align="center" :show-overflow-tooltip="true" v-if="columns[3].visible" prop="content" />
      <el-table-column label="创建时间" align="center" :show-overflow-tooltip="true" v-if="columns[4].visible" prop="createTime" />
...
import { listRecommend, getRecommend, delRecommend, addRecommend, updateRecommend } from "@/api/movie/recommend";
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/movie/recommend/importData"
      },
      // 表单校验
      rules: {
        id: [
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('movie/recommend/export', {
        ...this.queryParams
    ...
    importTemplate() {
      this.download(
        "movie/recommend/importTemplate",
        {},
