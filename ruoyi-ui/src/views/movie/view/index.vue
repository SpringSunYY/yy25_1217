<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="浏览编号" prop="id">
        <el-input
...
import { listView, getView, delView, addView, updateView } from "@/api/movie/view";
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/movie/view/importData"
      },
      // 表单校验
      rules: {
        id: [
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('movie/view/export', {
        ...this.queryParams
